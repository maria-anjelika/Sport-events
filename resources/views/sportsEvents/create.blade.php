...
<div class="panel-body">
    ...
    <form method="post" action="{{url('/sportsEvents')}}">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control form-control-lg" id="lgFormGroupInput6" placeholder="Enter name" name="organizerName">
            </div>
        </div>
        <div class="form-group row">
            {{csrf_field()}}
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control form-control-lg" id="lgFormGroupInput2" placeholder="Date" name="date">
            </div>
        </div>
        <div class="form-group row">
            {{csrf_field()}}
            <label for="type" class="col-sm-2 col-form-label col-form-label-lg">Continuance</label>
            <div class="col-sm-10">
                <input type="text" class="form-control form-control-lg" id="lgFormGroupInput5" placeholder="continuance:" name="continuance">
            </div>
        </div>
        <div class="form-group row">
            {{csrf_field()}}
